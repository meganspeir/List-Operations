...
def custom_equality(some_list, another_list):
    ...
    """
    index = 0
    list1, list2 = some_list, another_list # to prevent destroying the original list

    for i in list1:
        if not list2: # if list2 is shorter than list1, prevents out of range error
            return False
    ...
    if list2: # if list2 still has elements after loop, means list2 is longer than list1
        return False
